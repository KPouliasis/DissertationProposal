...
\end{array}
\and
\begin{array}[b]{c}{ x_1:A_1 \true, \ldots,   x_i:A_i\true}\\{\vdots}\\{\Longrightarrowp\true}
\end{array}
\end{mathpar}
...
\and
\inferrule*[right=Top] { } {\Longrightarrowp \in {\sf Type}}
\and
...
\begin{mathpar}
\inferrule*[right=$\Longrightarrowp$I] { } {\Turnsi {\Gamma} { \langle \rangle:\Longrightarrowp }}
\and
...
\begin{mdframed}
	\begin{mathpar}
		\inferrule*[right=$\eta\Longrightarrowp$]{\Gamma\vdash M:\Longrightarrowp}{\Gamma\vdash M\equiv \langle \ \rangle: \Longrightarrowp} 
		\and
...
$1$ is the terminal object, also called the final object, which corresponds to $\Longrightarrowp$. For any object $\Gamma$ there is a unique map $\Gamma\Longrightarrow 1$. 
\begin{mdframed}
\begin{mathpar}
