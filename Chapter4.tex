	...
	\mbox{\small
		...
		\begin{mdframed}[nobreak=true,frametitle={\footnotesize Sequent Calculus ({\sf Prop})}]
			...
			\begin{proof}
				...
				the proof is well-known. For the ${\sf Prop_1}$ part of the calculus again by induction.
				...
				elements of the shape of the axiomatic combinators are equivalent to $\top$.
				...
				The other cases of the induction are also trivial e.g. for the rule
