...
\mbox{
	...
	(it just assumes the basic requirements stated for the behavior \llbracket\dot\rrbracket). In this section
	we will provide a full calculus and in congruence with justification logic we will assume that the underlying systems
	($I$)  
