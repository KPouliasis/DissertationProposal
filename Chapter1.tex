...
The concept of \emph{algorithm} as a step--by--step constructive process is brought to the 
...
As Harper puts it \cite{Harper2013}\say{While formal proofs are always proofs (at least, under the assumption of consistency of the underlying formal theory), a proof need not be, or even have a representation as, a formal proof}.  
...
proofs for more complex facts (\emph{introduction rules}) and consumed
 ...
 A discussion on the meaning of the logical connectives that is prevalent in \ac{MLTT} can be found
...
assumptions about the truth (or, equivalently, proof) of other propositions. We  call these \emph{logical judgments}. 
