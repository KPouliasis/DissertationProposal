...
\section{Proof trees and proof terms}
...
Here are the the rules for constructing proof trees.
First, the deductions using reflection on hypothesis are valid:
\begin{mathpar}
\begin{array}[b]{c}{ A_1 \true,\ldots,  A_i\true}\\{\vdots}\\{A_{j\in 1\dots i} \true}
\end{array}
\end{mathpar}

\begin{mathpar}
	\inferrule[$\wedge$ Intro]{{\begin{array}[b]{c} {\mathcal{D}} \\ A\true  \end{array}}\\ {\begin{array}[b]{c} {\mathcal{E}} \\ B\true  \end{array}}}{A \wedge B \true}
	
\end{mathpar}
\begin{mathpar}
	\inferrule[$\wedge$ Elim$1$]{{\begin{array}[b]{c} {\mathcal{D}} \\ A\wedge B\true  \end{array}} }{A \true}
	\and
	\inferrule[$\wedge$ Elim$2$]{{\begin{array}[b]{c} {\mathcal{D}} \\ A\wedge B\true  \end{array}} }{B \true}
\end{mathpar}
\begin{mathpar}
...
%\end{mathpar}
 ...
 \subsection{Linear representation of trees  with proof terms}
