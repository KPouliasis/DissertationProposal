...
\begin{frame}{Roadmad}
 ...
 $A \ {\sf true}$ and $A {\sf valid}:=\  
 {\sf true}$ and treat necessity as “double theoremhood”
%   obtain a system of basic constructive modality investigating the minimal relation between these two systems
%   Use justification logic to axiomatize validity $\llbracket \sf {judgments}\rrbracket$.
\end{itemize}
\end{frame}
\end{document}
