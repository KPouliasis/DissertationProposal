...
\begin{frame}{Metatheory for (almost) free}
  \begin{outline}
    \1 []  The good old  way
        ...
        has an order theoretic model ()

    \1[] Cut elimination (core of CHI)
      \2[!]  Create a restricted versions of your calculus/ proof trees:
      \3[!!] does not permit Elim - After- Intro/ $\beta$ redexes 
  ...
  \begin{frame}
   ...
   \end{frame}
    ...
    \begin{mathpar}
        ...
        {\Gamma\vdash {\sf eval_J} \ \  {\sf j} :R\phi} 
    \end{mathpar}
    ...
    \begin{frame}
      ...
      \begin{mathpar}
          ...
          {\Gamma\vdash \sf {let} \ \_\_ \ \&\ s \ {\sf be\ } M \ \  {\sf in}\  {\sf eval} (s):R\llbracket\phi\rrbracket} 
      \end{mathpar}  
    \end{frame}  
